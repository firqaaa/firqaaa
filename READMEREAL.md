...
Hi 👋 there! I'm фирка, your AI trailblazer, weaving enchantment in the domains of Natural Language Processing (NLP) and the captivating universe of Computer Vision. Imagine a blend of state-of-the-art technology, linguistic elegance, and image wizardry, all dedicated to igniting the AI world with innovation. Currently throwing down as an AI/NLP maestro. I'm injecting a serious dose of cool into the Healthcare domain. Nice to meet you!


<!-- ## 🚀 Key Expertise

- **Natural Language Processing (NLP):** Adept in developing advanced NLP models and applications that bridge the gap between human communication and machine understanding.
- **Computer Vision:** Extensive experience in crafting solutions using computer vision, ranging from image recognition to object detection, enriching AI capabilities with visual data.
- **Machine Learning:** Extensive experience in designing, training, and deploying machine learning models for diverse applications within the field of AI.
- **Deep Learning:** Proficient in leveraging deep neural networks to solve complex problems, with a focus on enhancing language understanding and generation.
- **Data Science:** Skilled in extracting meaningful insights from large datasets, enabling data-driven decision-making. -->
...
<div align="center">
  <div align="left">
    ...
    <img style="margin-left:10px; margin-bottom:-1px" src="https://dvc.org/img/dvc_icon-color--square_vector.svg" alt="Bash" height="45" width=45 />
    <img style="margin:4px; margin-bottom:7px" src="https://repository-images.githubusercontent.com/191632914/c8406080-ee09-11ea-80c5-8df4b0341954" alt="Bash" height="35" width=70 />
    <img style="margin-left:-4px; margin-bottom:2px" src="https://images.ctfassets.net/xjan103pcp94/6oNaiHZAKoNJlor5jQF6Ql/746a80429fc50107cd96cbd35cd58ff6/ray_meetup.jpeg" alt="Bash" height="35" width="60" />
    ...
    <img style="margin-left:-5px; margin-bottom:3px" src="https://lh3.googleusercontent.com/enPnHXtcB23cC1zbJrAFmJ6hh9huJ4uWrCrBDMRv1BgvU6ys17cHsGCz3DabBJ7U5R8WgsKWzDmCjkIYV8XxGg" alt="Bash" height="35" width="35" />
    <img style="margin-left: 8px; margin-bottom: 3px" src="https://cdn.worldvectorlogo.com/logos/fastapi.svg" alt="Bash" height="35" width="35" />
    <img style="margin-left: 8px; margin-bottom: 3px" src="https://seeklogo.com/images/D/dask-logo-E2158E0CA9-seeklogo.com.png" alt="Bash" height="35" width="35" />
    <img style="margin-left: 8px; margin-bottom: 3px" src="https://mlflow.org/docs/latest/_static/MLflow-logo-final-black.png" alt="Bash" height="30" width="75" />
    <img style="margin-left:3px; margin-bottom:-3px" src="https://avatars.githubusercontent.com/u/26833451?s=200&v=4" alt="Bash" height="50" width="50" />
    <img style="margin-left:3px; margin-bottom:-3px" src="./images/248717394-398274c1-a572-477b-b115-52497a085496.png" alt="Bash" height="45" width="45" />
    <img style="margin-left:3px; margin-bottom:-3px" src="./images/88676955.png" alt="Bash" height="40" width="40" />
    <img style="margin-left:3px; margin-bottom:-3px" src="./images/5106378.png" alt="Bash" height="40" width="40" />
    <img style="margin-left:3px; margin-bottom:-18px" src="./images/0521174.png" alt="Bash" height="75" width="75" />
    <img style="margin-left:-10px; margin-bottom:-10px" src="./images/oqVQ04b5KiGt5WOWJmYt8.png" alt="Bash" height="55" width="55" />
    <img style="margin-left:-10px; margin-bottom:-3px" src="https://asset.brandfetch.io/idfDTLvPCK/idfkFVkJdH.png" alt="Bash" height="40" width="40" />
    <img style="margin-left:3px; margin-bottom:-3px" src="https://seeklogo.com/images/D/django-logo-4C5ECF7036-seeklogo.com.png" alt="Bash" height="40" width="40" />
...
[![HuggingFace](https://img.shields.io/badge/%F0%9F%A4%97-Huggingface-yellow)](https://huggingface.co/firqaaa)
